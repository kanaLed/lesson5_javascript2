function calculateTax(){
        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          }//end of Married filling jointly filer calculation
          ...
          *******************************************************************************/
             ...
             // Compute tax for Married Filling jointly filers
               if (income <= 19050){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
                 ...
                 tax = 19050 * 0.10 + (77400 - 19050) * 0.12 +
                       (16500 - 77400) * 0.22 + (income - 165000) * 0.24;
                 taxRate = 24;
               }//end of else if
                 ...
                 taxRate = 32;
                  ...
                  tax = 19050 * 0.10 + (77400 - 19050) * 0.12 +
                        (165000 - 774000) * 0.22 + (315000 - 165000) * 0.24 +
